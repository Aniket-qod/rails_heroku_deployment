...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference("Slider.count") do
      post sliders_url, params: { slider: { category_id: @slider.category_id, image: @slider.image, name: @slider.name, status: @slider.status } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { category_id: @slider.category_id, image: @slider.image, name: @slider.name, status: @slider.status } }
